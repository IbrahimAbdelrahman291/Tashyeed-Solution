...
using Tashyeed.Web.ViewModels.ProcurementM;

namespace Tashyeed.Web.Controllers
{
    [Authorize(Roles = RoleNames.ProcurementManager)]
    public class ProcurementManagerDashboardController : Controller
    {
        private readonly AppDBContext _context;

        public ProcurementManagerDashboardController(AppDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vm = new ProcurementManagerDashboardVM
            {
